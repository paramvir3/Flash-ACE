...
from flashace import FlashACECalculator
...
unit_atoms=read("start.xyz")
crystal_atoms = unit_atoms.repeat((1,1,1))
...
calculator = FlashACECalculator(model_path="model.pt", device='cuda')

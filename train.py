    ...
    for epoch in range(config['epochs']):
        ...
        for batch in train_loader:
            ...
            for item in batch:
                ...
                with torch.no_grad():
                    train_metrics.update(p_E, p_F, p_S, item['t_E'], item['t_F'], item['t_S'], n_ats)
        ...
        for batch in valid_loader:
            for item in batch:
                ...
                with torch.no_grad():
                    val_metrics.update(p_E, p_F, p_S, item['t_E'], item['t_F'], item['t_S'], n_ats)

...
def main():
    ...
    model = FlashACE(
        ...
        invariant_descriptor=config.get('invariant_descriptor', False),
        attention_edge_film=config.get('attention_edge_film', False),
        attention_edge_film_hidden=config.get('attention_edge_film_hidden', None),
        attention_scalar_post_norm=config.get('attention_scalar_post_norm', False),
        attention_scalar_post_gate=config.get('attention_scalar_post_gate', False),
        attention_tensor_post_gate=config.get('attention_tensor_post_gate', False),
